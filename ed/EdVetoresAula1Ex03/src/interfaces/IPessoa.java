...
public interface IPessoa {
    ...
    void incluirPessoa(Pessoa pessoa) throws Exception;

    Pessoa buscarPessoa(String nome) throws Exception;

    Pessoa[] consultar() throws Exception;
}
