 ...
 * @author vovostudio
 */
public class JDialogNome extends javax.swing.JDialog implements IModal {
     ...
     */
    public JDialogNome(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogNome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogNome dialog = new JDialogNome(new javax.swing.JFrame(), true);
